...
python merge_csvs.py --directory "${METRICS_DIR}/agreement_per_label/common_False/" --jsonl_path "$DATA_PATH"
python merge_csvs.py --directory "${METRICS_DIR}/agreement_per_label/common_True/" --jsonl_path "$DATA_PATH"

python merge_csvs.py --directory "${METRICS_DIR}/agreement_per_label/gt_counts_common_False/" --jsonl_path "$DATA_PATH"
python merge_csvs.py --directory "${METRICS_DIR}/agreement_per_label/gt_counts_common_True/" --jsonl_path "$DATA_PATH"
